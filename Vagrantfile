...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "file", source: "influxdb.conf", destination: "/etc/influxdb/"
  config.vm.provision "file", source: "configdb_influxdb.txt", destination: "/etc/influxdb/configdb_influxdb.txt"
